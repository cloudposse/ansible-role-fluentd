...
# ansible-fluentd [![Build Status](https://travis-ci.org/cloudposse/ansible-fluentd.svg?branch=master)](https://travis-ci.org/cloudposse/ansible-fluentd) [![Latest Release](https://img.shields.io/github/release/cloudposse/ansible-fluentd.svg)](https://travis-ci.org/cloudposse/ansible-fluentd/releases) [![Slack Community](https://slack.cloudposse.com/badge.svg)](https://slack.cloudposse.com)
...
- [ansible-role-fluentd](https://github.com/reallyenglish/ansible-role-fluentd) - Configures fluentd
...
File a GitHub [issue](https://github.com/cloudposse/ansible-fluentd/issues), send us an [email][email] or join our [Slack Community][slack].
...
Please use the [issue tracker](https://github.com/cloudposse/ansible-fluentd/issues) to report any bugs or file feature requests.
...
Copyright © 2016-2018 [Tomoyuki Sakurai](https://github.com/mitsururike)
